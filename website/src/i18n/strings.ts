...
const en: Strings = {
  ...
  hero: {
    tag: 'v0.2.4 · Free · Open Source · No ads · No telemetry',
  ...
  cta: { title: 'Get unfetch v0.2.4', desc: 'No ads. No telemetry. No login.', button: 'Download installer' },
...
const zh: Strings = {
  ...
  cta: { title: '立即获取 unfetch v0.2.4', desc: '无广告 · 无遥测 · 无登录', button: '下载安装包' },
...
const ja: Strings = {
  ...
  hero: {
    tag: 'v0.2.4 · 無料 · オープンソース · 広告なし · テレメトリーなし',
  ...
  cta: { title: 'unfetch v0.2.4 を入手', desc: '広告なし · テレメトリーなし · ログインなし', button: 'インストーラーをダウンロード' },
...
const ko: Strings = {
  ...
  hero: {
    tag: 'v0.2.4 · 무료 · 오픈소스 · 광고 없음 · 텔레메트리 없음',
  ...
  cta: { title: 'unfetch v0.2.4 받기', desc: '광고 없음 · 텔레메트리 없음 · 로그인 없음', button: '설치 프로그램 다운로드' },
...
const de: Strings = {
  ...
  hero: {
    tag: 'v0.2.4 · Kostenlos · Open Source · Keine Werbung · Keine Telemetrie',
  ...
  cta: { title: 'unfetch v0.2.4 holen', desc: 'Keine Werbung · Keine Telemetrie · Kein Login', button: 'Installer herunterladen' },
...
const fr: Strings = {
  ...
  hero: {
    tag: 'v0.2.4 · Gratuit · Open source · Sans pub · Sans télémétrie',
  ...
  cta: { title: 'Obtenir unfetch v0.2.4', desc: 'Sans pub · Sans télémétrie · Sans connexion', button: 'Télécharger l\'installeur' },
...
const es: Strings = {
  ...
  hero: {
    tag: 'v0.2.4 · Gratis · Código abierto · Sin anuncios · Sin telemetría',
  ...
  cta: { title: 'Consigue unfetch v0.2.4', desc: 'Sin anuncios · Sin telemetría · Sin login', button: 'Descargar instalador' },
...
const pt: Strings = {
  ...
  hero: {
    tag: 'v0.2.4 · Gratuito · Open source · Sem anúncios · Sem telemetria',
  ...
  cta: { title: 'Obtenha o unfetch v0.2.4', desc: 'Sem anúncios · Sem telemetria · Sem login', button: 'Baixar instalador' },
...
const it: Strings = {
  ...
  hero: {
    tag: 'v0.2.4 · Gratuito · Open source · Senza pubblicità · Senza telemetria',
  ...
  cta: { title: 'Ottieni unfetch v0.2.4', desc: 'Senza pubblicità · Senza telemetria · Senza login', button: 'Scarica installer' },
...
const pl: Strings = {
  ...
  hero: {
    tag: 'v0.2.4 · Darmowe · Open source · Bez reklam · Bez telemetrii',
  ...
  cta: { title: 'Pobierz unfetch v0.2.4', desc: 'Bez reklam · Bez telemetrii · Bez logowania', button: 'Pobierz instalator' },
...
const nl: Strings = {
  ...
  hero: {
    tag: 'v0.2.4 · Gratis · Open source · Geen reclame · Geen telemetrie',
  ...
  cta: { title: 'Haal unfetch v0.2.4', desc: 'Geen reclame · Geen telemetrie · Geen login', button: 'Installer downloaden' },
...
const tr: Strings = {
  ...
  hero: {
    tag: 'v0.2.4 · Ücretsiz · Açık kaynak · Reklamsız · Telemetrisiz',
  ...
  cta: { title: 'unfetch v0.2.4\'yi edinin', desc: 'Reklam yok · Telemetri yok · Giriş yok', button: 'Yükleyiciyi indir' },
...
const sv: Strings = {
  ...
  hero: {
    tag: 'v0.2.4 · Gratis · Öppen källkod · Reklamfri · Ingen telemetri',
  ...
  cta: { title: 'Hämta unfetch v0.2.4', desc: 'Ingen reklam · Ingen telemetri · Ingen inloggning', button: 'Ladda ner installerare' },
...
const uk: Strings = {
  ...
  hero: {
    tag: 'v0.2.4 · Безкоштовно · Open source · Без реклами · Без телеметрії',
  ...
  cta: { title: 'Отримати unfetch v0.2.4', desc: 'Без реклами · Без телеметрії · Без логіну', button: 'Завантажити інсталятор' },
